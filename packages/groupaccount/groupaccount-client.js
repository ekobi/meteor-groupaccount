...
/**
   @desc Callback functions for the GroupAccounts.* methods all have the same signature and return semantics.
...
/**
   @desc Reports, and optionally modifies, configuration paramters for currently-logged-in group account. Asynchronous.
...
/**
   @desc Removes an existing existing user from a group. Must be logged in to group account. Asynchronous.
